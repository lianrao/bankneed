...
var mpopTimer = 0;
mmenucolor='#5C97D4';mfontcolor='#ffffff';mmenuoutcolor='#345A91';mmenuincolor='#345A91';mmenuoutbordercolor='';mmenuinbordercolor='';mmidoutcolor='#000000';mmidincolor='#000000';mmenuovercolor='#FFFFFF';mitemedge='1';msubedge='0';mmenuunitwidth=80;mmenuitemwidth=120;mmenuheight=23;mmenuwidth='100%';mmenuadjust=0;mmenuadjustV=0;mfonts='font-family: 宋体; color: #FFFFFF; ';mcursor='default';
...
mpmenu0=new mMenu('首页','main.jsp','parent','','','','');

mpmenu1=new mMenu('系统管理','','self','','','','');
mpmenu1.addItem(new mMenuItem('机构代码维护','infomodify.htm','self',false,'','','','',''));
//mpmenu1.addItem(new mMenuItem('人员标识整合/拆分','personsort_search.htm','self',false,'','','','',''));
...
//mpmenu2.addItem(new mMenuItem('报文登记信息查询','reportregisterinfo_search.htm','self',false,'','','','',''));
//mpmenu2.addItem(new mMenuItem('人员标识整合/拆分信息查询(征信机构)','personmarkinfo_search1.htm','self',false,'','','','',''));
//mpmenu2.addItem(new mMenuItem('人员标识整合/拆分信息查询','personmarkinfo_search2.htm','self',false,'','','','',''));
//mpmenu2.addItem(new mMenuItem('银行机构代码信息查询','bankcodesearch.htm','self',false,'','','','',''));
//mpmenu2.addItem(new mMenuItem('黑名单信息查询','blacklistselect.htm','self',false,'','','','',''));
...
//mpmenu3=new mMenu('离线服务','','self','','','','');
//mpmenu3.addItem(new mMenuItem('个人支付信用信息组合查询','offpayilligal.htm','self',false,'','','','',''));
//mpmenu3.addItem(new mMenuItem('个人黑名单信息组合查询','offblack.htm','self',false,'','','','',''));
//mpmenu3.addItem(new mMenuItem('下载离线查询结果','offsearchresult.htm','self',false,'','','','',''));
//mpmenu3.addItem(new mMenuItem('下载离线查询结果','offsearchresult.htm','',false,'','','','',''));
//mpmenu3.addItem(new mMenuItem('异议处理专线','','',false,'','','','',''));
...
//mpmenu5=new mMenu('联系我们','','self','','','','');
//mpmenu5.addItem(new mMenuItem('中心简介','info.htm','self',false,'','','','',''));
//mpmenu5.addItem(new mMenuItem('联系方式','info.htm','self',false,'','','','',''));

//mpmenu5=new mMenu('资料下载','datadownload.jsp','self',false,'','','','','');
